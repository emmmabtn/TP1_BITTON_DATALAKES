...
def run():
    account_name = os.getenv('STORAGE_ACCOUNT_NAME', "csb10037ffead93967e")
    account_key = os.getenv('STORAGE_ACCOUNT_KEY', "yovLaaxpqmQndNspKOc8lSVgqroADR34oR9QNWHg4YJDD+fgqqh6YtHqSQ6DzgpmA/inNqnCXmGF+ASt3zcLbA==")
